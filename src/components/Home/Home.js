...
const Home = () => {
  ...
  <div className="hero-content flex-col lg:flex-row-reverse">
    ...
    <div>
      <h1 className="text-5xl font-bold">A <span className='text-blue-500'>reader</span> lives a <br></br> thousand lives <span className='text-blue-500'>before he dies</span></h1>
...
I still find the human mind amazing. You can see what is ultimately a bunch of scribbles on a page, decipher them into sounds, turn those sounds into words, and then turn those words into thoughts and emotions.</p>
      <button className="btn btn-outline btn-info">Visit Store</button>
    </div>
    <Player 
